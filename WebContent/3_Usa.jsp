...
<article class="box post">
  ...
  <header class=" bg-img text-black text-center" >
    <div class="container">
      <img class="img-fluid mb-5 d-block mx-auto" src="img/usa.jpg" alt="">
      <h1 class="text-uppercase mb-0">U.S.A</h1>
      <hr class="star-light">
      <h2 class="font-weight-light mb-0">별들의 나라 미국</h2>
    </div>
  </header>
