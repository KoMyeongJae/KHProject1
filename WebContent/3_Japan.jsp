...
for(J_weather_osaka jwt : list2){
	jsonWt += "현재 일본 날씨 "+"<br>" + jwt.getJW_o_spt() + "℃";
}
...
<body id="page-top">
  ...
  <!-- Header -->
  <header class="masthead bg-img text-black text-center" >
    <div class="container">
      <img class="img-fluid mb-5 d-block mx-auto" src="img/japan.jpg" alt="">
      <h1 class="text-uppercase mb-0">JAPAN</h1>
      <hr class="star-light">
      <h2 class="font-weight-light mb-0">벚꽃의 나라 일본</h2>
    </div>
  </header>
  ...
  <section class="portfolio" id="portfolio">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">CITY</h2>
  ...
  <section class="bg-primary text-white mb-0" id="about">
    <div class="container">
      <h2 class="text-center text-uppercase text-white">Exchange</h2>
      <hr class="star-light mb-5">
      <div class="row">
        <div class="col-lg-4 ml-auto" > 
          <h3 class="text-center text-uppercase text-white" ><%=request.getAttribute("jsonEx") %></h3>    
        </div>
  ...
  <section id="contact">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">WEATHER</h2>
      <hr class="star-dark mb-5">
      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">만든 사람</h4>
          <p class="lead mb-0">박상록
            </p>
        </div>
        <div class="col-md-4 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">another trip</h4>
          <ul class="list-inline mb-0">
            <li class="list-inline-item">
              <a class="btn btn-outline-light btn-social text-center rounded-circle" href="3_Usa.jsp">
                U
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn btn-outline-light btn-social text-center rounded-circle" href="3_vietnam.jsp">
                V
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn btn-outline-light btn-social text-center rounded-circle" href="3_Rusia.jsp">
               R
              </a>
            </li>
          </ul>
        ...
        <div class="col-md-4">
          <h4 class="text-uppercase mb-4">메인으로</h4>
          <p class="lead mb-0">
            <a href="1_3MainPage.jsp">Triplan</a></p>
        </div>
      </div>
    </div>
  </footer>
