<%@page import="Weather.U_W_L_mm"%>
<%@page import="Weather.U_W_H_mm"%>
<%@page import="Weather.U_W_N_mm"%>
<%@page import="Weather.U_Wether"%>
...
%>
<%
List<U_Wether> list2 = U_W_N_mm.getWeather();
List<U_Wether> list3 = U_W_H_mm.getWeather();
List<U_Wether> list4 = U_W_L_mm.getWeather();

String jsonWt = "";

for(U_Wether Unwt : list2){
   jsonWt += "뉴&nbsp;&nbsp;&nbsp;욕: "+ Unwt.getU_spt() + "℃"+"<br>";
}
for(U_Wether Ulwt : list4){
   jsonWt += "L&nbsp;&nbsp;.&nbsp;&nbsp;A : "+ Ulwt.getU_spt() + "℃"+"<br>";
}
for(U_Wether Uhwt : list3){
   jsonWt += "하와이 : "+ Uhwt.getU_spt() + "℃";
}
