...
%>
<%
PerCalendarDto dto = (PerCalendarDto)request.getAttribute("update");
		...
		<section id="main">
			<div class="container">
				<div class="row">
					...
					<h3>개인 일정</h3>
					<div align="center">
					<form action="PerCUpdateCtlr">
					<input type="hidden" name="command" value="updateAf">
					<input type="hidden" name="seq" value="<%=dto.getSeq()%>">
					<input type="hidden" name="id" value="<%=user.getId()%>">
					<table class="type03" style="margin-bottom: 1em;">
					<col width="10%"><col width="90%">
					<tr>
					  <th scope="row">Title</th>
					  <td scope="row">
					    <input type="text" name="title" value="<%=dto.getTitle()%>" style="width: 40%; background-color: white; border: 1px solid; border-color: lightgray;">
					  </td>
					</tr>
					<tr>
					  <th scope="row">Start</th>
					  <td scope="row">
					    <input type="text" id="rstartdate" name="rstartdate" value="<%=toDates(dto.getRstartdate()) %>" style="width: 40%; background-color: white; border: 1px solid; border-color: lightgray;">
					  </td>
					</tr>
					<tr>
					  <th scope="row">End</th>
					  <td scope="row">
					    <input type="text" id="renddate" name="renddate" value="<%=toDates(dto.getRenddate()) %>" style="width: 40%; background-color: white; border: 1px solid; border-color: lightgray;">
					  </td>
					</tr>
					<tr>
						<td colspan="2" scope="row">
							<textarea rows="20" name="content" style="resize: none; width: 80%; background-color: white; border: 1px solid; border-color: lightgray;">
							<%=dto.getContent() %>
							</textarea>
						</td>
					</tr>
