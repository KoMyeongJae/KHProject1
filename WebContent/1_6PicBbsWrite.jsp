		...
		<section id="main">
			<div class="container">
				<div class="row">
					...
					<!-- 이곳에 리스트를 뿌려줄겁니다 -->
					<form id="frm"  action="PicAddCtlr" name="write_form" method="get">
					<h3>후기 게시판</h3>
						<table border="1">
						...
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="title" style="width: 100%; background-color: white; border: 1px solid; border-color: lightgray;" placeholder="게시글 제목을 입력하세요">
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<textarea style="width: 100%" rows="10" name="content" id="textAreaContent"></textarea>
						...
						<div align="center">
							<input type="hidden" name="command" value="PicAdd">
