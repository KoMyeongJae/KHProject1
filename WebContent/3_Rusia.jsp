...
for(Exchange.R_Exchange jex : list){
	jsonEx += "현재 러시아 환율 :" + jex.getR_spt() + "원";
}
...
<body id="page-top">
  ...
  <header class="masthead bg-img text-black text-center" >
    <div class="container">
      <img class="img-fluid mb-5 d-block mx-auto" src="img/russia.jpg" alt="">
      <h1 class="text-uppercase mb-0">RUSSIA</h1>
      <hr class="star-light">
      <h2 class="font-weight-light mb-0">눈의 나라 러시아</h2>
    </div>
  </header>
