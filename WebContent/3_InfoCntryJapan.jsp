<%@page import="J_W.J_W_T_MAX"%>
<%@page import="J_W.J_W_T_MIN"%>
<%@page import="J_W.J_W_F_MAX"%>
<%@page import="J_W.J_W_F_MAX2"%>
<%@page import="J_W.J_W_F_MIN"%>
<%@page import="J_W.J_W_O_MAX"%>
<%@page import="J_W.J_W_O_MIN"%>
<%@page import="J_W.J_W_T_mm"%>
<%@page import="J_W.J_W_F_mm"%>
<%@page import="J_W.J_W_O_mm"%>
...
String Owt = J_W_O_mm.getWeather();
String OwtMin = J_W_O_MIN.getWeather();
String OwtMax = J_W_O_MAX.getWeather();


String Fwt = J_W_F_mm.getWeather();
String FwtMin = J_W_F_MIN.getWeather();
String FwtMax = J_W_F_MAX.getWeather();


String Twt = J_W_T_mm.getWeather();
String TwtMin = J_W_T_MIN.getWeather();
String TwtMax = J_W_T_MAX.getWeather();
									        ...
									        <div class="col-lg-8 mx-auto">
									             <h3 class="text-center text-uppercase text-black" >
									             	<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto">
				                                       <input hidden="" id="OWea" value="<%=Owt%>">
				                                       <input hidden="" id="FWea" value="<%=Fwt%>">  
				                                       <input hidden="" id="TWea" value="<%=Twt%>">
				                                       <input hidden="" id="OWeaMin" value="<%=OwtMin%>">
				                                       <input hidden="" id="FWeaMin" value="<%=FwtMin%>">
				                                       <input hidden="" id="TweaMin" value="<%=TwtMin%>">
				                                       <input hidden="" id="OWeaMax" value="<%=OwtMax%>">
				                                       <input hidden="" id="FWeaMax" value="<%=FwtMax%>">
				                                       <input hidden="" id="TweaMax" value="<%=TwtMax%>">
			                                       </div>
		                                 ...
		                                 <div class="container text-center">
		                                   <div class="row">
		                                     <div class="col-lg-8 mx-auto">
		                                      ...
		                                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.444733277952!2d135.49910661518797!3d34.66872348044269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e713818af9fd%3A0xb8bb1326b48ba590!2z64-E7Yak67O066as!5e0!3m2!1sko!2skr!4v1551937233882" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                    ...
		                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.444733277952!2d135.49910661518797!3d34.66872348044269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e714602937cd%3A0x26b149a204023d46!2z64-I7YKk7Zi47YWMIOuPhO2GpOuztOumrOygkA!5e0!3m2!1sko!2skr!4v1551937423185" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                    <hr>
		                                    ...
		                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3280.047667556207!2d135.497999065189!3d34.703977630433734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e693a3c00001%3A0xab7a911d9eafca70!2z7Ze17YyM7J2067iMIOuMgOq0gOuejOywqA!5e0!3m2!1sko!2skr!4v1551937601765" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                     <hr>
		                                     ...
		                                     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3279.9971636637238!2d135.4882412151891!3d34.70525148043327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e6889aeab56d%3A0x47c0e47c5c90e387!2z7Jqw66mU64ukIOqzteykkeygleybkA!5e0!3m2!1sko!2skr!4v1551937562663" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                     <hr>
		                                    ...
		                                    <p class="mb-5">유니버설 스튜디오 재팬은 여러 유니버설 스튜디오 놀이공원 중 하나로 일본 오사카 시에 있으며, 2001년 3월 31일 토요일에 개장했다.<br> 일본에서 드림랜드 등 다른 테마파크들이 줄줄이 망하는 상황에서도 대형업체가 운영한다는 점으로 말미암아 크나큰 성공을 거둔 테마파크다.<br> 걸어서 5분거리에 유니버설시티역이 있으므로 JR 전철을 타고 가면 편하게 찾아갈 수 있다.<br> 입장료는 세금포함 성인이 7900엔 정도로 한국의 놀이공원에 비해 꽤 비싼편이지만, 어트랙션들이 정말 잘 만들어져있고, 내부에 극장이 5개 정도 있어서 뮤지컬이나 쇼를 볼 수도 있으며, 거의 모든 시설을 공짜로 이용할 수 있기 때문에[9] 막상 들어가보면 입장료가 그리 비싸게 느껴지진 않을 것이다.<br> 다만 파크 내부에서 파는 음식이나 기념품들은 상당히 비싸므로 주의.</p>
		                                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.5747106947915!2d135.43014951518794!3d34.66544198044366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e0d083d5e25d%3A0x3605fe25303252aa!2z7Jyg64uI67KE7ISkIOyKpO2KnOuUlOyYpCDsnqztjKw!5e0!3m2!1sko!2skr!4v1551937582051" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe><br>
		                                 ...
		                                 <div class="container text-center">
		                                   <div class="row">
		                                     <div class="col-lg-8 mx-auto">
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.481702478323!2d139.7681584152155!3d35.66513933019799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601889647120144f%3A0x57c9eadb7b62ef7f!2z7JOw7YKk7KeAIOyLnOyepQ!5e0!3m2!1sko!2skr!4v1552004097653" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12965.209120134865!2d139.7567398341243!3d35.66955828315046!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188be701836fbb%3A0x604685b30ba99851!2z7J2867O4IOOAkjEwNC0wMDYxIOuPhOy_hCDrj4Qg7KO87JikIOq1rCDquLTsnpA!5e0!3m2!1sko!2skr!4v1552004215002" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6481.610566515749!2d139.75136197597627!3d35.68179622077665!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188c0d02d8064d%3A0xd11a5f0b379e6db7!2z6rOg7L-E!5e0!3m2!1sko!2skr!4v1552004239882" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12958.371142156182!2d139.76685118414312!3d35.711637232993596!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188e9e8b28ebb3%3A0x9bba88ca3db2f4be!2z7J2867O4IOOAkjExMC0wMDA1IOuPhOy_hCDrj4Qg64uk7J207YagIOq1rCDsmrDsl5Drhbg!5e0!3m2!1sko!2skr!4v1552004277035" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <br>
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12957.494173936846!2d139.79000863414566!3d35.71703073297356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188ec2047f5333%3A0x7c84fd3881c74067!2z7J2867O4IOOAkjExMS0wMDMyIOuPhOy_hCDrj4Qg64uk7J207YagIOq1rCDslYTsgqzsv6Dsgqw!5e0!3m2!1sko!2skr!4v1552004296695" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3239.6567846113167!2d139.80851171521678!3d35.710062680187555!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188ed0d12f9adf%3A0x7d1d4fb31f43f72a!2z64-E7L-EIOyKpOy5tOydtO2KuOumrA!5e0!3m2!1sko!2skr!4v1552004314076" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.7902771008735!2d139.87820561521465!3d35.6328963802056!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60187d03114737b3%3A0xe4d93636d509d3cb!2z64-E7L-EIOuUlOymiOuLiOuenOuTnA!5e0!3m2!1sko!2skr!4v1552004335545" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
		                                         <i class="fa fa-close"></i>
		                                         Close</a>
		                                 ...
		                                 <div class="container text-center">
		                                   <div class="row">
		                                     <div class="col-lg-8 mx-auto">
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13294.86054038402!2d130.39788783321433!3d33.58674479176037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3541918e44e39077%3A0xe8214e0d1793b30!2z64207KeE!5e0!3m2!1sko!2skr!4v1552004387918" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <p class="mb-5">운하(캐널)를 둘러싸듯 호텔, 공연극장, 영화관, 숍, 레스토랑, 전문매장, 쇼룸<br> 등이 한 곳에 모인 복합상업시설.<br> 매일 열리는 분수 쇼와 이벤트뿐 아니라 쇼핑과 레저 그리고, 맛있는 먹거리 등 이곳에는 언제나 즐거운 시간들이 기다리고 있다.<br>외국 관광객도 많이 방문하는 후쿠오카의 관광지로서 빠질 수 없는 인기 장소다.</p>
		                                         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.5963935518585!2d130.40853161515892!3d33.58982708073429!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354191958981c361%3A0xe0edba177a7419d1!2z7LqQ64SQ7Iuc7YuwIO2VmOy5tO2DgA!5e0!3m2!1sko!2skr!4v1552004421989" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                         <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.4639719887223!2d130.34932571515904!3d33.593264180733385!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354193aa23040001%3A0xf9743b36617a912d!2z7ZuE7L-g7Jik7Lm0IO2DgOybjA!5e0!3m2!1sko!2skr!4v1552004437431" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <p class="mb-5">후쿠오카(福岡) 타워」의 북쪽에 펼쳐지는 인공 해수욕장의 공원.<br> 「후쿠오카시종합도서관」 「후쿠오카시박물관」 「후쿠오카 야후오쿠! 돔」으로부터도 가까운, 인공모래사장의 중앙에는 「마리존」이 있다.<br> 모래사장에서는 비치 발리볼이나 비치 축구등의 비치 스포츠가 왕성하다.<br> 밤은 해면에 비치는 도회의 야경을 즐길 수 있고, 밤낮 막론하고 후쿠오카시 유수의 인기 데이트 장소이기도 한다.</p>
		                                         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.4054994256503!2d130.35084131515913!3d33.59478178073274!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354193ab85629313%3A0x4641f742d4ac3370!2z7ZuE7L-g7Jik7Lm0IOuqqOuqqOy5mCDtlbTrs4Dqs7Xsm5A!5e0!3m2!1sko!2skr!4v1552004519835" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3326.2375978042437!2d130.53262471515714!3d33.5212076807538!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35419b9f2aebfbcd%3A0xb824d1aba75fae97!2z64uk7J6Q7J207ZuE7YWQ66eM6rWs!5e0!3m2!1sko!2skr!4v1552004457911" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       ...
		                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d53366.25816023241!2d131.32002219188922!3d33.28242889037052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3546ac2f5f729f87%3A0xfe31fae0fb807bd5!2z7J2867O4IOOAkjg3OS01MTAyIOyYpOydtO2DgCDtmIQg7Jyg7ZuEIOyLnCDsnKDtm4TsnbjstIgg6rCA7JmA7Lm066-4!5e0!3m2!1sko!2skr!4v1552004469784" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		                                       <hr>
		                                       <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#"> 
		                                         <i class="fa fa-close"></i>
		                                         Close</a>
...
<script type="text/javascript">
var OSAKA_to =document.getElementById("OWea").value;
var OSAKA_toMin = document.getElementById("OWeaMin").value;
var OSAKA_toMax = document.getElementById("OWeaMax").value;
OSAKA_to = Number(OSAKA_to);
OSAKA_toMin = Number(OSAKA_toMin);
OSAKA_toMax = Number(OSAKA_toMax);

var FUKUOKA_to =document.getElementById("FWea").value;
var FUKUOKA_toMin = document.getElementById("FWeaMin").value;
var FUKUOKA_toMax = document.getElementById("FWeaMax").value;
FUKUOKA_to = Number(FUKUOKA_to);
FUKUOKA_toMin = Number(FUKUOKA_toMin);
FUKUOKA_toMax = Number(FUKUOKA_toMax);

var TOKYO_to =document.getElementById("TWea").value;
var TOKYO_toMin = document.getElementById("TweaMin").value;
var TOKYO_toMax = document.getElementById("TweaMax").value;
TOKYO_to = Number(TOKYO_to);
TOKYO_toMin = Number(TOKYO_toMin);
TOKYO_toMax = Number(TOKYO_toMax);
...
Highcharts.chart('container', {
    ...
    series: [{
        name: 'Tokyo',
        data: [TOKYO_toMin, TOKYO_to, TOKYO_toMax]
    }, {
        name: 'Osaka',
        data: [OSAKA_toMin, OSAKA_to, OSAKA_toMax]
    },{
       name:'Fukuoka',
        data:[FUKUOKA_toMin, TOKYO_to, FUKUOKA_toMax]
    }]
});
</script>
