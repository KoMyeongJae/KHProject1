					   ...
					   <div class="center">
							...
							<tr>
							   ...
							   <td colspan="2" style="padding-bottom: 0.5em;">
							      <input type="text" name="title" size="50" value="<%=qbbs.getTitle() %>" style="background: white; border: 1px solid; border-color: lightgray;">      
							   </td>
							</tr>
							<tr>
						  		<td colspan="3" style="padding-bottom: 0.5em;">
<!-- textarea 입력 시 공백 부분 없애기 위해서 왼쪽에 붙인거야 -->
<textarea rows="10" cols="50" name="content" style="resize: none;
