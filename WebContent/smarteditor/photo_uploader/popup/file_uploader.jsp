...
//String path = "C:/personal_project/KHProject1/WebContent/upload"; // 이미지가 저장될 주소
String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "/smarteditor/upload";
//System.out.println("test: " + request.getSession().getServletContext().getRealPath("/") + File.separator);
System.out.println("test: " + request.getSession().getServletContext().getRealPath("/"));
