...
%>
<%
PicBbsDto dto = (PicBbsDto)request.getAttribute("dto");
		...
		<section id="main">
			<div class="container">
				<div class="row">
					...
					<!-- 이곳에 리스트를 뿌려줄겁니다 -->
					<form id="frm"  action="PicUpdateCtlr" name="write_form" method="get">
					<h3>후기 게시판</h3>
						<table style="margin-top: 2em;">
						<col width="80px"><col width="720px">
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="title" style="width: 100%; background-color: white; border: 1px solid; border-color: lightgray;" value="<%=dto.getTitle() %>">
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<textarea style="width: 100%" rows="10" name="content" id="textAreaContent">
								<%=dto.getContent() %>
								</textarea>
								<!-- <input type="text" name="contents" id="textAreaContent" required=""> -->
							</td>
						</tr>
						</table>
						<div align="center">
							<input type="hidden" name="command" value="update_PicBbs">
							<input type="hidden" name="seq" value="<%=seq %>">
							<input type="hidden" name="pic" id="pic_path">
...
// textArea에 이미지 첨부 + 대표 이미지 저장 공간 설정
