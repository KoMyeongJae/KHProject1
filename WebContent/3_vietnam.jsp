...
for(Exchange.V_Exchange jex : list){
	jsonEx += "현재 베트남 환율 :" + jex.getV_spt()+ "원";
}
...
<body id="page-top">
  ...
  <header class="masthead bg-img text-black text-center" >
    <div class="container">
      <img class="img-fluid mb-5 d-block mx-auto" src="img/Vietnam.png" alt="">
      <h1 class="text-uppercase mb-0">VIETNAM</h1>
      <hr class="star-light">
      <h2 class="font-weight-light mb-0">햇빛의 나라 베트남</h2>
    </div>
  </header>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">
              <a class="btn btn-outline-light btn-social text-center rounded-circle" href="3_Japan.jsp">
                J
              </a>
            </li>
            <li class="list-inline-item">
